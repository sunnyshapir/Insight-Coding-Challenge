...
#java -jar fansite-analytics-challenge/src/ProcessLog.jar "fansite-analytics-challenge/log_input/log.txt" "fansite-analytics-challenge/log_output/hosts.txt" "fansite-analytics-challenge/log_output/resources.txt" "fansite-analytics-challenge/log_output/hours.txt" "fansite-analytics-challenge/log_output/blocked.txt"
